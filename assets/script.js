...
$(document).ready(function () {
    ...
    var pageContent = document.querySelector("#projects");

    // // 1
    // var intro = document.createElement("h1");   
    // intro.textContent = "front end developer +";
    ...
    // // 2
    // var intro = document.createElement("h1");   
    // intro.textContent = "UI/UX designer";
    ...
    // // 3
    // var intro = document.createElement("h1");   
    // intro.textContent = "based in seattle";
    ...
    // // 4
    // var intro = document.createElement("h1");   
    // intro.textContent = "currently focused on";
    ...
    // // 5
    // var intro = document.createElement("h1");   
    // intro.textContent = "design systems @Microsoft";
  ...
  // hide non-required elements
    ...
    // $( "intro:hidden" ).first().fadeIn( "slow" );

//     var showLine1 = $('#line_one').removeClass('hidden');
// setTimeout(function() {
//     showLine1.addClass('intro');
// }, 2000);

// var showLine2= $('#line_two').removeClass('hidden');
// setTimeout(function() {
//     showLine2.addClass('intro');
// }, 8000);

$("#projects-title").fadeOut(1000);
$("#project-row1").fadeOut(1000);
$("#project-row2").fadeOut(1000);
$("#project-row3").fadeOut(1000);
...
$(window).on('scroll', function() {
    ...
    //     sectionTitle.textContent = "Projects: 2020 - 2021";

    // pageContent.appendChild(sectionTitle);
    // $("h1").addClass("projects-title");

    
        // } else {
        //   $("#project-row1").fadeOut();
        // }
});